...
Route::get('/users/details',[PagesController::class,'list'])->name('users.details')->middleware('adminMiddleware');
Route::get('/users/details/{id}',[PagesController::class,'details'])->name('user.details');
Route::get('/users/delete/{id}',[PagesController::class,'delete'])->name('delete');